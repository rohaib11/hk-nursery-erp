import { Leaf, X, ImagePlus, Calculator } from 'lucide-react';
...
export default function PlantModal({ isOpen, onClose, plant, setPlant, onSubmit, editMode, viewMode }) {
  ...
  const handleFormSubmit = (e) => {
    ...
    // If the entire batch is marked dead in edit mode, zero the stock
